...
@Entity
@Table(name = "BIPS_BLACKLIST")	
public class BIPS_BlackList {
	...
	public BIPS_BlackList(String corporatename, String brn, Date brn_date, String mbl_num, String brn_unit,
	...
	public String toString() {
		return "BIPS_BlackList [corporatename=" + corporatename + ", brn=" + brn + ", brn_date=" + brn_date

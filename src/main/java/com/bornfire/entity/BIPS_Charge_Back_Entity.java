...
public class BIPS_Charge_Back_Entity {
	...
	public BIPS_Charge_Back_Entity(String akg_desc, String akg_status, Date akg_time, Date auth_time, String auth_user,
			...
			String user_ref, Date value_date, String unit_id, String unit_name, String revert_status_flg,
			BigDecimal chargeback_amount, String chargeback_approval) {
		super();
		this.akg_desc = akg_desc;
		this.akg_status = akg_status;
		this.akg_time = akg_time;
	...
	public BIPS_Charge_Back_Entity(BIPS_Outward_Trans_Monitoring_Entity outEntity) {
		...
		this.ipsx_status_error = outEntity.getIpsx_status_code();
		...
		// this.revert_status_flg = outEntity.;
	}

...
@Entity
@Table(name = "BIPS_NEGATIVELIST")	
public class BIPS_NegativeList {
	...
	public BIPS_NegativeList(String corporatename, String brn, Date brn_date, String mbl_num, String brn_unit,
	...
	public String toString() {
		return "BIPS_NegativeList [corporatename=" + corporatename + ", brn=" + brn + ", brn_date=" + brn_date

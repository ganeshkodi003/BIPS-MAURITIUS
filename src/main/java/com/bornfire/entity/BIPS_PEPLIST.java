...
@Entity
@Table(name = "BIPS_PEPLIST")	
public class BIPS_PEPLIST {
	...
	public BIPS_PEPLIST(String corporatename, String brn, Date brn_date, String mbl_num, String brn_unit,
	...
	public String toString() {
		return "BIPS_PEPLIST [corporatename=" + corporatename + ", brn=" + brn + ", brn_date=" + brn_date + ", mbl_num="
				+ mbl_num + ", brn_unit=" + brn_unit + ", brn_date_unit=" + brn_date_unit + ", mbl_num_unit="
				+ mbl_num_unit + ", national_id=" + national_id + ", remark=" + remark + ", entity_flag=" + entity_flag
				+ ", entry_time=" + entry_time + ", entry_user=" + entry_user + ", verify_time=" + verify_time
				+ ", verify_user=" + verify_user + ", srl_no=" + srl_no + "]";
	}
	public BIPS_PEPLIST() {
		super();

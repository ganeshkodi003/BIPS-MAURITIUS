...
@Entity
@Table(name = "BIPS_BANK_AND_BRANCH_MOD")
public class BankAndBranchBeanMod {
	...
	public BankAndBranchBeanMod(String bank_code, String bank_name, String sol_id, String sol_desc, String addr_1,
	...
	public BankAndBranchBeanMod(BankAndBranchBean modData) {

...
@Table(name="MERCHANT_FEES_SERVICE_CHARGES")
@Entity
@IdClass(MerchantFeeID.class)
public class MerchantFeesServiceCharges {
    @Id
    ...
    public MerchantFeesServiceCharges(String srl_no,String merchant_id, String fee_desc, String fee_type, String amount_per, String fee_freq, String vat_collect, String del_flg) {
        this.srl_no = srl_no;
        this.merchant_id = merchant_id;
        this.fee_desc = fee_desc;
        this.fee_type = fee_type;
    ...
    public MerchantFeesServiceCharges() {
        super();
 
    }
    
    public MerchantFeesServiceCharges( MerchantFeesServiceChargesMod up) {

...
public class MerchantMaster {
	...
	public MerchantMaster(MerchantMasterMod user) {
		...
		this.fee_desc_r1 = user.getFee_desc_r1();
		this.fee_type_r1 = user.getFee_type_r1();
		this.amount_per_r1 = user.getAmount_per_r1();
		this.fee_freq_r1 = user.getFee_freq_r1();
		this.vat_collect_r1 = user.getVat_collect_r1();
